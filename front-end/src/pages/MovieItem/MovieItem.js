...
export default function MovieItem({ isAuthenticated, keys, match, location }) {
  ...
  function handleIsInWatchList() {
    const movieId = match.params.id;
    fetch("http://localhost:7070/api/watch/hasWatchLink/" + movieId, {
      headers: {
  ...
  function handleIsInFavorites() {
    const movieId = match.params.id;
    fetch("http://localhost:7070/api/liked/isLiked/" + movieId, {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      },
  ...
  function addToWatchList() {
    const movieId = match.params.id;
    fetch("http://localhost:7070/api/watch/", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  function addToFavorites() {
    const movieId = match.params.id;
    fetch("http://localhost:7070/api/liked/", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  async function handleRemove(id, endpoint) {
    ...
    await fetch("http://localhost:7070/api/" + endpoint + "/" + id, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
                  ...
                  <div className="movie-buttons">
                    {isInWatchList ? (
                      ...
                      >
                        ...
                        <span>Já está na lista de observação</span>
                      </div>
                    ) : (
